...
## Group state protocols

The previous section described the group membership protocol, which allows a group to be established and maintained.

This section now goes into how the group state protocol, embedded within the `JOIN_GROUP` and `SYNC_GROUP` APIs, allows members of the group to partition "work" between them.
