...
seqdiag {
  ...
  edge_length = 250;  // default value is 192
  span_height = 15;  // default value is 40
  consumer1; consumer2; "grp_coordinator\n(broker 12)";
  
  consumer1 -> "grp_coordinator\n(broker 12)" [label = "SYNC_GROUP"];
  consumer2 -> "grp_coordinator\n(broker 12)" [label = "SYNC_GROUP assignments=1->foo, 2->bar"];
  consumer1 <-- "grp_coordinator\n(broker 12)" [label = "assignments=foo"];
  consumer2 <-- "grp_coordinator\n(broker 12)" [label = "assignments=bar"];
}
....
